...
export default function Welcome() {
  ...
  return (
    <section className="max-w-3xl mx-auto py-10 px-6 text-center mt-2 lg:mt-6">
      <h1 className="text-4xl font-bold text-foreground mb-6">
        Welcome to <span className="text-gray-700 dark:text-gray-300">Promptcraft
          <span className="text-primary">.ai</span></span> 🚀
      </h1>

      <p className="text-muted-foreground text-lg mb-6">
        Promptcraft.ai is your all-in-one AI toolkit designed to boost productivity by providing smart content tools, image editing features, and career enhancement services — all in one place.
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-left mb-10 px-8 py-2">
